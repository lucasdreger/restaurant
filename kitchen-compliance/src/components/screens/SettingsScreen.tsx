...
import { ArrowLeft, Check, Users, UtensilsCrossed, Sun, Moon, Palette, CreditCard, Mic, Plus, Trash2, Volume2, ShieldCheck, UserPlus, Coffee, Thermometer, Edit2, X, Building2, RotateCcw } from 'lucide-react'
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="input-stunning text-xl font-bold"
                    />
